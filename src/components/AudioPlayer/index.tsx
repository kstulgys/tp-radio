...
export function AudioPlayer({ songState }) {
  return (
    ...
    >
      <Stack display={["none", "flex"]} flex={1} isInline alignItems="center" spacing={[0, 5]}>
      ...
      <Stack spacing={0} display={["none", "flex"]} flex={1} isInline justifyContent="center">
        <Box>
...
function AudioPlayerControls() {
  ...
  return (
    <Stack flex={1} isInline spacing={[0, 3]} justifyContent={["center", "flex-end"]} alignItems="center">
      <Stack spacing={0} isInline alignItems="center">
        <Button display={["none", "flex"]} variant="unstyled" onClick={onToggleMute}>
          <Icon as={MutedIcon} color="gray.100" fontSize="xl" mb={1} />
        </Button>
      </Stack>
      <Stack isInline spacing={[0, 8]} justifyContent={["center", "flex-end"]} alignItems="center">
